...
Rectangle {
    ...
    Panel {
        ...
        Column {
            ...
            spacing: 2
            Repeater {
                model: Math.max(0, Math.floor((panel.height - 32) / 3))
                delegate: Rectangle { width: panel.width - 4; height: 1; color: "#ffffff"; opacity: 0.16 }
            }
        }
        ...
        Rectangle {
            ...
            color: root.cfg("titleColor", "#487697")
            ...
            Text {
                ...
                text: (typeof sddm !== "undefined" && sddm.hostName) ? sddm.hostName : "TenshiSTEP-zirconium"
        ...
        Column {
            ...
            Row {
                ...
                spacing: 9
                NeXTButton {
                    width: 118; height: 28; text: "Sleep"; textColor: "#487697"
        ...
        Column {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    color: sma.containsMouse ? "#487697" : "#ffffff"
                    Text {
    ...
    Connections {
        ...
        function onLoginSucceeded() { err.text = "" }
    }
