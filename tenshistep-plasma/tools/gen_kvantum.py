#!/usr/bin/env python3
"""
Generate the TenshiSTEP Kvantum SVG (TenshiSTEP.svg). Kvantum looks up
...
"""
import os
OUT = os.path.join(os.path.dirname(__file__), '..', 'kvantum', 'TenshiSTEP')
...
def combo_arrow(direction, col):
    WELL, ITL, IBR, FR = '#9aa1ac', '#5c626b', '#ffffff', '#1a1a1a'
    def d(ox, oy, s):
...
open(os.path.join(OUT, 'TenshiSTEP.svg'), 'w').write(svg)
