    ...
    Panel {
        ...
        Column {
            ...
            Text {
                ...
                color: "#dcdfe4"; font.family: "Helvetica"; font.pixelSize: 15; font.bold: true
            }

            Grid {
                width: parent.width
                columns: 3; spacing: 10
                NeXTButton { width: 118; height: 30; text: "Sleep"; textColor: "#9a90ee"; visible: root.canSuspend; onClicked: root.suspendRequested(2) }
                NeXTButton { width: 118; height: 30; text: "Restart"; textColor: "#e0a850"; visible: root.canReboot; onClicked: root.rebootRequested() }
                NeXTButton { width: 118; height: 30; text: "Shut Down"; textColor: "#d67a6f"; visible: root.canShutdown; onClicked: root.haltRequested() }
                NeXTButton { width: 118; height: 30; text: "Log Out"; textColor: "#dcdfe4"; visible: root.canLogout; onClicked: root.logoutRequested() }
                NeXTButton { width: 118; height: 30; text: "Lock"; textColor: "#9aa0a8"; onClicked: root.lockScreenRequested() }
                NeXTButton { width: 118; height: 30; text: "Cancel"; textColor: "#dcdfe4"; onClicked: root.cancelRequested() }
            }
        }
    }
