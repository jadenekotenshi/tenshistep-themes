/*
 * TenshiSTEP window switcher (dark) — NeXT/OPENSTEP idiom.
 *
...
Item {
    ...
    // NeXT bevel palette (dark).
    readonly property color colBase:      "#3b4048"
    ...
    readonly property color colText:      "#e6e8ec"
